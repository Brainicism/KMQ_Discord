...
exports.up = function (knex) {
    return knex.schema
        ...
        .table("badges_players", function (table) {
            table.dropUnique(["user_id", "badge_name"], "badges_user_id_badge_name_unique");
            table.integer("badge_id").references('id').inTable('badges').notNull().onDelete('CASCADE').alter();
...
exports.down = function (knex) {
    return knex.schema
        .table("badges_players", (table) => {
            ...
            table.unique(["user_id", "badge_name"], "badges_user_id_badge_name_unique");
        })
        .table("badges", function (table) {
