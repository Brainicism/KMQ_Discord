...
export class KmqImages {
    public static READING_BOOK = "https://lovearrowshoot.me/kmq/images/book_bg.png";
    public static NOT_IMPRESSED = "https://lovearrowshoot.me/kmq/images/not_impressed_bg.png";
