SELECT name AS song_name, vlink AS link, kpop_videos.app_kpop_group.name AS artist_name, kpop_videos.app_kpop.views AS views
...
AND kpop_videos.app_kpop_group.name IN ('?', '?')
